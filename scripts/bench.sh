...
PIPELINE_FLUSH_BATCH_SIZE="${PIPELINE_FLUSH_BATCH_SIZE:-unspecified}"
PIPELINE_FLUSH_MAX_DELAY_MS="${PIPELINE_FLUSH_MAX_DELAY_MS:-unspecified}"
BACKEND_AFFINITY_STRATEGY="${BACKEND_AFFINITY_STRATEGY:-unspecified}"
...
pipeline_flush_batch_size=${PIPELINE_FLUSH_BATCH_SIZE}
pipeline_flush_max_delay_ms=${PIPELINE_FLUSH_MAX_DELAY_MS}
backend_affinity_strategy=${BACKEND_AFFINITY_STRATEGY}
EOF_META
