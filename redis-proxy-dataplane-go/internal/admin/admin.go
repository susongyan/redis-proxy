...
func NewServer(addr string, cfg *config.Config, rt *router.Manager, pools *backend.Pools, reg *metrics.Registry, hotKeys *analysis.HotKeyTracker, largeKeys *analysis.LargeKeyTracker) *http.Server {
